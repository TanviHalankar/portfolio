  ...
  const contactMethods = [
    {
      ...
      title: "Email",
      value: "tanvihalankar312@gmail.com",
  ...
  const socialLinks = [
    {
      ...
      url: "https://github.com/TanviHalankar",
      description: "Check out my code",
    },
    {
      name: "LinkedIn",
      icon: <Linkedin className="h-6 w-6" />,
      url: "https://linkedin.com/in/tanvi-halankar",
              ...
              <Card className="bg-zinc-800/50 border-zinc-700/50">
                ...
                <CardContent>
                  ...
                  >
                    ...
                    <input type="hidden" name="_next" value="https://tanvihalankar-portfolio.vercel.app/" />
